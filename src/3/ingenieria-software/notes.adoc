...
La gestión de riesgos es dinámica: se va actualizando a medida que avanzamos. En
un principio algo puede ser poco riesgoso e ir incrementando con el tiempo.
