...
Ángulo en sentido contrario respecto del semieje x.
Simétrico respecto del eje $y$.
Otra manera de $\bar{z}$.

\textbf{Opuesto.}

Ángulo más $180^o$. O sea, $-z$.
...
Queda un hexágono regular, en una circunferencia de radio $\sqrt[n]{|z|}$.

\subsection{Complejos en forma exponencial}

Napier descubre $e$, y Eluer trabaja y desarrolla la constante.
