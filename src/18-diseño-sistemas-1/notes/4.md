...
TODO: 
- Ver qué pasa con el resguardo de los datos personales.
- Dividir los requerimientos funcionales
- Para la clase que viene: documento SRS 830
- Factibilidad legal
...
- Incluye preguntas respecto de cómo solucionar problemas. Qué hacemos nosotros
para resolver un problema. Hay que encontrar los problemas en los requerimientos
- Un multiple choice
- Un verdadero falso
