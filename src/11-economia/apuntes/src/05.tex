...
Una elasticidad alta indica un elevado grado de respuesta de la cantidad demandada a la variación en el precio,
...
Para evitar que la elasticidad sea distinta,
según se mida desde el punto A hacia el B,
o desde el B hacia el A,
se calcula una elasticidad promedio,
