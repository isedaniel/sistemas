...
La transacción de las acciones se realiza en la \emph{bolsa}, que ni más ni
menos, es un mercado, donde entran en contacto compradores y vendedores,
inversionistas y empresas. También la bolsa de considera que cumple una función
en el crecimiento de una economía, ya que canaliza el ahorro hacia la inversión
productiva.

\subsection{Ejemplos de bolsas mundiales}

En Estados Unidos se comercializan las acciones en lo que se denomina Wall
Street. No obstante, hay que tener en cuenta los índices accionarios o
bursátiles que indican el crecimiento o no del mercado accionario. El índice
más conocido es el Dow Jones, este índice es representativo de las 30 mayores
compañias industriales de Estados Unidos, y se compilan sumando los precios de
sus acciones y luego divido por una constante 'x'.
Y que en 2018 pasan a ser 30.
...
Como el índice Dow Jones ha quedado obsoleto, atento a que es un promedio de
empresas industriales -las 30 \emph{bluechips}-, no representa las
transacciones diarias en Estados Unidos. Con lo cual se han creado nuevos
índices, a saber: 

Standard & Poor's 500, compuesto por 400 acciones industriales, 20 del sector
transporte, 40 de servicios públicos y 40 financieras.

Amex Composite, índice de todas las acciones que se venden en un mercado
